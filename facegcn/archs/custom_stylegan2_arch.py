...
@ARCH_REGISTRY.register()
class StyleGAN2NoStdDiscriminator(nn.Module):
    """StyleGAN2 Discriminator.
    ...
    def __init__(self, out_size, channel_multiplier=2, resample_kernel=(1, 3, 3, 1), stddev_group=4, narrow=1):
        super(StyleGAN2NoStdDiscriminator, self).__init__()
...
if __name__ == '__main__':
    net = StyleGAN2NoStdDiscriminator(out_size=512).to("cuda:0")
    print(net)
    ipt = torch.randn(2,3,512,512).to("cuda:0")
    res = net(ipt)
    print(res.shape)
